import{u as n,j as o}from"./index-OBK253pP.js";import{M as i,z as m}from"./vendor-ui-BgnAtmuh.js";import{r as a}from"./vendor-core-Cler3e7Q.js";import"./vendor-utils-Dg5_7-NF.js";const h=({record:l,visible:t,onClose:s})=>{const{t:d}=n(),r=a.useRef(null);return a.useEffect(()=>{r.current&&(r.current.scrollTop=r.current.scrollHeight)},[t,l.log]),a.useEffect(()=>{const e=document.createElement("style");return e.textContent=`
