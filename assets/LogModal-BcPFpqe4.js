import{u as n,j as o}from"./index-DcyBWYzV.js";import{M as i,E as m}from"./vendor-ui-CJOmdTmk.js";import{r as a}from"./vendor-core-Cler3e7Q.js";import"./vendor-utils-MXilNKRg.js";const h=({record:l,visible:t,onClose:s})=>{const{t:d}=n(),r=a.useRef(null);return a.useEffect(()=>{r.current&&(r.current.scrollTop=r.current.scrollHeight)},[t,l.log]),a.useEffect(()=>{const e=document.createElement("style");return e.textContent=`
